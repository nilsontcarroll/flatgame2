...
let soundtrack;
var player;
var numOfItems = 5; //set this number to number of items in items folder!
var frame;
var item = [];
...
function preload(){
    ...
    item[4] = loadAnimation('assets/spider1.png','assets/spider2.png','assets/spider3.png','assets/spider4.png')
    item[4].location = {'x':800,'y':500};
